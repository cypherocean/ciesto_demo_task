...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('shop.insert') }}" name="form" id="form" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('POST')
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-sm-6">
                                ...
                                <input type="email" name="email" id="email" class="form-control digit" placeholder="Plese enter email" value="{{ @old('email') }}">
                                <span class="kt-form__help error email"></span>
                            </div>
                            <div class="form-group col-sm-12">
                                <label for="address">address</label>
                                <textarea name="address" id="address" class="form-control" cols="30" rows="10" placeholder="Plese enter address" value="{{ @old('address') }}"></textarea>
